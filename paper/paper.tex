...
% Es steht der Vorwurf im Raum, die unteren Einkommen seien falsch abgebildet, weil die Sozialhilfe nicht versteuert ist
...
%%
% Population coverage
% Analysen zu den Nullern aufzeigen> ist eine Hauptkritik an der Nutzung von Steuerdaten

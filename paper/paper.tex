...
% the credit suisse wealth report allready uses wealth tax records, but they use it only for the period from 2000-2011. They did exactly the same for Denmark and Norway, which could be interessting to compare.
% Erbschaftssteuer erwähnen und bei den Global Wealth Reports der Credit Suisse und den Studien im Forschungsantrag weitermachen.

...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/With_and_without_equivalence_scale} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/Comparing_2003_to_20101} 
...
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/Comparing_2003_to_20102} 
...
\includegraphics[width=\maxwidth]{figure/specialcases93943} 
\begin{kframe}\begin{verbatim}
## Smoothing using 0.4
## Smoothing using 0.4
## Smoothing using 0.4
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/specialcases93944} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/specialcases101} 

\includegraphics[width=\maxwidth]{figure/specialcases102} 

\includegraphics[width=\maxwidth]{figure/specialcases103} 
\begin{kframe}\begin{verbatim}
## Smoothing using 0.4
## Smoothing using 0.4
## Smoothing using 0.4
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/specialcases104} 
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/setup_data1} 
\begin{kframe}\begin{verbatim}
## Smoothing using 0.4
## Smoothing using 0.4
## Smoothing using 0.4
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/setup_data2} 

\includegraphics[width=\maxwidth]{figure/setup_data3} 
\begin{kframe}\begin{verbatim}
## Smoothing using 0.4
## Smoothing using 0.4
## Smoothing using 0.4
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/setup_data4} 

\includegraphics[width=\maxwidth]{figure/setup_data5} 
\begin{kframe}\begin{verbatim}
## Smoothing using 0.4
## Smoothing using 0.4
## Smoothing using 0.4
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/setup_data6} 

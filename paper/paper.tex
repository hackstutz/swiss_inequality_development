...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: splines}}\end{kframe}% latex.default(format(c(`Median Index` = med, `Lower Index` = lower,      `Upper Index` = upper, `$\\Delta$ Gini` = dgini), digits = ndig),      file = "", title = title) 
%
\begin{table}[!tbp]
\begin{center}
\begin{tabular}{ll}
...
% latex.default(format(c(`Median Index` = med, `Lower Index` = lower,      `Upper Index` = upper, `$\\Delta$ Gini` = dgini), digits = ndig),      file = "", title = title) 
%
\begin{table}[!tbp]
\begin{center}
\begin{tabular}{ll}

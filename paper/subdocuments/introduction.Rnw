...
% Allenfalls könnte man auch (Nolan und Whealan, 2014) erwähnen. "The social Impact of income inequality: Poverty, Deprivation, and Social Cohesion" Da werden die Thesen rund um die Folgen von Ungleichheit gut zusammengefasst. Wobei: Jetzt scheint es mir jetzt ziemlich knackig und flüssig
...
%%%%
% 0) In der Methods-Sektion beschreiben was wir machen? So was wie eine Forschungsstrategie/Vorgehensweise
% Wie ausführlich?
% Gini-Koeffizient, Relative Distribution-Methods. Berechnung?

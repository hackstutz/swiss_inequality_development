...
% the credit suisse wealth report already uses wealth tax records, but they use it only for the period from 2000-2011. They did exactly the same for Denmark and Norway, which could be interesting to compare.

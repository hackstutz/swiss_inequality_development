...
dflong$Gini[dflong$kanton=="CH"&dflong$bemessungsjahre<2003&dflong$Type=="including non-taxed"]<-NA
dflong$Gini[dflong$kanton=="CH"&dflong$bemessungsjahre<2003&dflong$Type=="imputed values for non-taxed"]<-NA
...
# export nach stata (ungewichtet)
bern_plain_hh <- rbind(data.frame("income" = bern_kt2012_plain$eink_satz_dbs/1000,"group"=0,"weight"=1),data.frame("income" = bern_kt2012$eink_satz_dbs_hh/1000,"group"=1,"weight"=1))

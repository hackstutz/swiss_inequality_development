...
fig_incomes <- ggplot(dflong[dflong$kanton=="CH",], aes(x=steuerperiode,y=Gini,shape=Income))+
  scale_y_continuous(limits=c(0.28,0.55))+
  scale_x_continuous(limits=c(1941,2011),breaks=number_ticks(10)) +
  geom_point(aes(shape=Income),size=3)+
  geom_line(data=dflong[dflong$kanton=="CH",],aes(linetype=Income))+
  theme_bw()+
  xlab("Year")+
  theme(legend.justification=c(0,1),legend.position=c(0, 1))+
  ggtitle("Using net, taxable or taxed income")
fig_incomes
...
fig_zeros <- ggplot(dflong[dflong$kanton=="CH",], 
  ...
  scale_y_continuous(limits=c(0.28,0.55))+
  scale_x_continuous(limits=c(2003,2011),breaks=number_ticks(10)) +
  geom_line(size=0.5)+
  geom_point(aes(shape=Type),size=3)+
  theme_bw()+
  xlab("tax period")+
  theme(legend.justification=c(0,1),legend.position=c(0, 1))+
  ggtitle("How to treat non-taxed")
fig_zeros

...
format(rpy(y=bd.2010.ind$inc,yo=bd.2003.ind$inc,
           ywgt=bd.2010.ind$wgt,yowgt=bd.2003.ind$wgt,pvalue=FALSE),
       digits=3) # Median Index, middle value is the estimate 
format(rpluy(y=bd.2010.ind$inc,yo=bd.2003.ind$inc,
             ywgt=bd.2010.ind$wgt,yowgt=bd.2003.ind$wgt,pvalue=FALSE),
       digits=3) # Lower Index
format(rpluy(y=bd.2010.ind$inc,yo=bd.2003.ind$inc,
             ywgt=bd.2010.ind$wgt,yowgt=bd.2003.ind$wgt,pvalue=TRUE,
             upper=TRUE),

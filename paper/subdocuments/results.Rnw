...
<<specialcases9394, echo=FALSE,warning=FALSE,fig.cap=''>>=
...
#special <- read.csv("data/ginis_und_perzentile_sonder.csv",sep="\t")
...
<<specialcases09, echo=FALSE,warning=FALSE,fig.cap=''>>=
library(foreign)
library(ggplot2)
#library(reldist)

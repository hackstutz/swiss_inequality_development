...
# Export data to use with Stata (psteink durch VerfuegbaresEinkommen08 ersetzt)
habe_bd_2010 <- rbind(data.frame(cbind("income" = habe10$VerfuegbaresEinkommen08,"group"=0,"weight"=habe10$gew)),data.frame("income" = bd.2010.ind,"group"=1,"weight"=1))

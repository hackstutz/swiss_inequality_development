...
# Export data to use with Stata
habe_bd_2010 <- rbind(data.frame(cbind("income" = habe10$psteink,"group"=0,"weight"=habe10$gew)),data.frame("income" = bd.2010.ind,"group"=1,"weight"=1))
...
# Export data to use with Stata
habe_bd_2010_unmarried <- rbind(data.frame(cbind("income" = habe10.unmarried$inc_habe,"group"=0)),data.frame("income" = bd.2010.ind,"group"=1))

...
dflong$Income <- factor(dflong$Income,levels=c("taxable income","taxable income after federal tax","net income"))
...
fig_zeros <- ggplot(filter(dflong,kanton=="CH"&
  ...
  ((bemessungsjahre==1993.5|bemessungsjahre>=2003)&Type!="without non-taxed"))), 
       aes(x=bemessungsjahre,y=Gini,shape=Type,linetype=Type))+
  scale_y_continuous(limits=c(0.28,0.55))+
  scale_x_continuous(limits=c(1970,2011),breaks=number_ticks(10)) +
  geom_line(size=linesize)+
  geom_point(aes(shape=Type),size=pointsize)+
  theme_bw()+
  xlab("Year")+
  theme(legend.justification=c(0,1),legend.position=c(0, 1))+
...
try(bern_kt<-read.dta("U:/Persönlich/Forschung/Uni Bern/taxdata_BE_12.dta"))
...
<<<<<<< HEAD
bern_kt <- filter(bern_kt,VON=="2012-01-01",BIS=="2012-12-31")
bern_kt <- filter(bern_kt,Satzeink_BUND<=TOTEINK)
=======
bern_kt <- filter(bern_kt,von=="2012-01-01",bis=="2012-12-31")
bern_kt <- filter(bern_kt,Satzeink_BUND<=TOTEINK,erm==0)
>>>>>>> 3e5538522df3f18e4981b2d4c5813fc02e5f5e3a
bern_kt <- filter(bern_kt,erm==0)
...
=======
P:\WGS\FBS\ISS\Projekte laufend\SNF Ungleichheit\Datengrundlagen\Kantonale Steuerdaten\Bern
bern <- filter(bern,Satzeink_BUND<=TOTEINK,erm==0)
bern <- filter(bern,erm==0)
>>>>>>> 3e5538522df3f18e4981b2d4c5813fc02e5f5e3a
...
# legend order
<<<<<<< HEAD
levels(bern_gini_long$Income) <- c("total income", "taxable income", "Disposable income")
bern_gini_long$Income <- factor(bern_gini_long$Income,levels=c("total income", "taxable income", "Disposable income"))
=======
levels(bern_gini_long$Income) <- c("total income", "taxable income", "disposable income")
bern_gini_long$Income <- factor(bern_gini_long$Income,levels=c("total income", "taxable income", "disposable income"))
bern_gini_long$Income <- factor(bern_gini_long$Income,levels=c("taxable income","total income","disposable income"))
>>>>>>> 3e5538522df3f18e4981b2d4c5813fc02e5f5e3a

fig_bern_gini <- ggplot(bern_gini_long, aes(x=stj,y=Gini)) +
  scale_y_continuous(limits=c(0.28,0.55))+
  scale_x_continuous(breaks=number_ticks(5)) +
  geom_point(aes(shape=Income),size=5)+
...
=======
  theme(legend.justification=c(0,1),legend.position=c(0, 0.75))+
>>>>>>> 3e5538522df3f18e4981b2d4c5813fc02e5f5e3a

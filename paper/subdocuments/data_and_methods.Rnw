...
% Etwas zu den Problemen von Taxevasion sagen. Wissen wir da was zur Schweiz. 
% Tax evasion can be a problem, that biases the assessment of inequality. Alvaredo and Saez (2006) regard estimates of Spanish top incomes prior to 1981 as unreliable due to widespread tax evasion
...
In context with tax statistics 
...
% Allenfalls etwas zur Beschaffenheit der Daten und den sich daraus ergebeneden M�glichkeiten des Einsatzes von Masszahlen sagen. (falls m�glich)> da k�nnte auch explizit auf Top-income measures eingegangen werden
